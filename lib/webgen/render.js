...
// grid columns that avoid an orphaned last row (4 → 2×2, 3 → 3, 6 → 3, else 3)
const ccols = (n) => (n <= 1 ? 1 : (n === 2 || n === 4) ? 2 : (n % 3 === 0 ? 3 : n <= 3 ? n : 3));
const cover = (url) => (url ? `<img src="${esc(url)}" alt="" loading="lazy" onerror="var p=this.closest('.card-img,.photo,.about-img,.hero-media');if(p)p.remove();" />` : "");
...
const SHARED = `
  *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
  ...
  .page-hero-bg{position:absolute;inset:0;background:linear-gradient(120deg,var(--hero-a),var(--hero-b));z-index:-2}
  .page-hero-bg img{width:100%;height:100%;object-fit:cover;opacity:.5}
  .page-hero::after{content:"";position:absolute;inset:0;background:var(--overlay);z-index:-1}
  .page-hero .eyebrow{color:var(--on-dark-muted)}.page-hero h1{color:#fff;max-width:820px}
...
const CSS_EDITORIAL = `
  ...
  .topbar{background:var(--ink);color:var(--on-dark-muted);font-size:11px;letter-spacing:2px;text-transform:uppercase;text-align:center;padding:9px}
  ...
  .hero-bg{position:absolute;inset:0;background:linear-gradient(120deg,var(--hero-a),var(--hero-b));z-index:-2}.hero-bg img{width:100%;height:100%;object-fit:cover;opacity:.6}
  ...
  .hero .wrap{width:100%}.hero .eyebrow{color:var(--on-dark-muted)}.hero h1{color:#fff;max-width:640px;margin:14px 0 26px}.hero p{max-width:520px;color:var(--on-dark);margin-bottom:32px}
  ...
  .strip{background:var(--ink);color:var(--on-dark-muted);padding:26px 0}.strip .wrap{display:flex;flex-wrap:wrap;justify-content:center;gap:14px 46px;font-size:12px;letter-spacing:2px;text-transform:uppercase}
  .section{padding:100px 0}.center{text-align:center;max-width:760px;margin:0 auto 56px}.center p{margin-top:22px}
  .cards{display:grid;grid-template-columns:repeat(var(--ccols,3),1fr);gap:28px}.card{background:var(--cream);border:1px solid var(--line);padding:0 0 34px}.card:hover{transform:translateY(-6px)}
  ...
  .testi{background:var(--ink);color:var(--on-dark);padding:110px 0}.testi .eyebrow{color:var(--on-dark-muted)}.testi h2{color:#fff}
  .quotes{display:grid;grid-template-columns:repeat(2,1fr);gap:34px;margin-top:52px}.quote{border:1px solid var(--line-dark);padding:36px 34px}
  .quote h4{font-family:var(--serif);font-size:22px;color:#fff;margin-bottom:16px}.quote p{font-size:14px;color:var(--on-dark-muted);margin-bottom:18px}.quote cite{font-style:normal;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:var(--on-dark-muted)}
  ...
  footer{background:var(--ink);color:var(--foot-fg);padding:70px 0 34px;font-size:13px}.foot-grid{display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px;margin-bottom:50px}
  ...
  .foot-bottom{border-top:1px solid var(--line-dark);padding-top:24px;display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px;font-size:11px}
...
const CSS_BOLD = `
  body{background:var(--ink);color:var(--on-dark)}h1,h2,h3{color:#fff}
  ...
  /* the about + testi sections are LIGHT (cream) in bold — use dark buttons there so they aren't white-on-cream */
  .about .btn,.testi .btn{border-color:var(--ink);color:var(--ink)}.about .btn:hover,.testi .btn:hover{background:var(--ink);color:#fff}
  ...
  .nav ul{list-style:none;display:flex;gap:30px}.nav ul a{font-size:12px;letter-spacing:1.5px;text-transform:uppercase;color:var(--on-dark)}.nav ul a:hover{color:var(--accent)}
  .logo{font-family:var(--serif);font-size:28px;letter-spacing:5px;color:#fff}
  .nav-right{display:flex;align-items:center;gap:20px}.phone{font-size:13px;color:var(--on-dark)}
  ...
  .hero-bg{position:absolute;inset:0;background:linear-gradient(120deg,var(--hero-a),var(--hero-b));z-index:-2}.hero-bg img{width:100%;height:100%;object-fit:cover;opacity:.5}
  ...
  .hero .wrap{width:100%}.hero h1{max-width:12ch;margin:16px 0 24px}.hero p{max-width:520px;color:var(--on-dark);margin-bottom:34px;font-size:17px}
  ...
  .center{max-width:820px;margin:0 auto 64px}.center .eyebrow,.center h2{text-align:center}.center p{margin-top:22px;text-align:center;color:var(--foot-fg)}
  .cards{display:grid;grid-template-columns:repeat(var(--ccols,3),1fr);gap:2px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.08)}
  ...
  .card-body{padding:34px 30px}.card--text .card-body{padding-top:60px}.card h3{margin-bottom:14px}.card p{color:var(--foot-fg)}.card .btn{margin-top:24px}
  ...
  .feat{display:grid;grid-template-columns:repeat(3,1fr);gap:24px;margin-top:60px}.feat article{border:1px solid rgba(255,255,255,.12);padding:44px 34px}.feat h3{margin-bottom:16px}.feat p{color:var(--foot-fg)}.feat .btn{margin-top:24px}
  .cta{text-align:center;padding:140px 0;background:radial-gradient(ellipse at center,var(--hero-b),var(--ink))}.cta p{max-width:560px;margin:22px auto 34px;color:var(--on-dark-muted)}.cta .contactline{margin-top:30px;font-size:13px;letter-spacing:2px;text-transform:uppercase;color:var(--accent)}
  footer{background:var(--foot-bg);color:var(--foot-fg);padding:80px 0 34px;font-size:13px}.foot-grid{display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px;margin-bottom:50px}
  footer h5{font-family:var(--serif);color:#fff;font-size:14px;letter-spacing:2px;margin-bottom:18px}footer ul{list-style:none}footer li{margin-bottom:10px}footer a:hover{color:#fff}
...
const CSS_MINIMAL = `
  ...
  .btn--light{border-bottom:1px solid #fff}.btn--light:hover{background:transparent;color:var(--on-dark-muted);border-color:var(--on-dark-muted)}
  ...
  .cards{display:grid;grid-template-columns:repeat(var(--ccols,3),1fr);gap:1px;background:var(--line);border-block:1px solid var(--line)}.card{background:var(--white);padding:0}
...
const CSS_AURA = `
  ...
  .btn{border:1px solid var(--accent);color:var(--ink);padding:15px 36px}.btn:hover{background:var(--accent);color:var(--on-accent);border-color:var(--accent)}
  ...
  .hero-bg{position:absolute;inset:0;background:linear-gradient(120deg,var(--hero-a),var(--hero-b));z-index:-2}.hero-bg img{width:100%;height:100%;object-fit:cover;opacity:.72}
  .hero::after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(60,50,40,.5),rgba(60,50,40,.1));z-index:-1}
  .hero .wrap{width:100%}.hero .eyebrow{color:#f0e6d6}.hero h1{color:#fff;max-width:680px;margin:14px 0 26px}.hero p{max-width:540px;color:var(--on-dark);margin-bottom:32px;font-size:17px}
  ...
  .cards{display:grid;grid-template-columns:repeat(var(--ccols,3),1fr);gap:30px}
  ...
  footer{background:var(--ink);color:var(--foot-fg);padding:74px 0 34px;font-size:13px}.foot-grid{display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px;margin-bottom:50px}
...
const CSS_CLINICAL = `
  ...
  .cards{display:grid;grid-template-columns:repeat(var(--ccols,3),1fr);gap:26px}
...
<style>
  :root{--cream:${t.cream || "#fffbf5"};--white:${t.white || "#ffffff"};--ink:${t.ink || "#323232"};--body:${t.body || "#585858"};--line:${t.line || "#e5ddd2"};--accent:${t.accent || "#8a7a63"};--serif:"${t.serifFont || "Cormorant Garamond"}",Georgia,serif;--sans:"${t.sansFont || "Montserrat"}",sans-serif;--wrap:1200px;
    --hero-a:${t.heroA || "#2a2a2a"};--hero-b:${t.heroB || "#4a4034"};--overlay:${t.overlay || "rgba(20,17,13,.55)"};--on-dark:${t.onDark || "#f5f1ea"};--on-dark-muted:${t.onDarkMuted || "#c9c3ba"};--foot-bg:${t.footBg || "#1a1815"};--foot-fg:${t.footFg || "#a99f92"};--line-dark:${t.lineDark || "rgba(255,255,255,.14)"};--on-accent:${t.onAccent || "#ffffff"}}
  ${SHARED}${d.css}${variantCss(v || variantOf(k))}
</style></head><body>`;
}
...
function pageHero(k, intro, title) {
  ...
  return `<section class="page-hero"><div class="page-hero-bg">${i.image ? cover(i.image) : ""}</div><div class="wrap">
      ...
      ${i.body ? `<p style="max-width:600px;margin:18px auto 0;color:var(--on-dark)">${esc(i.body)}</p>` : ""}</div></section>`;
}
...
function specialtiesSection(k, d) {
  ...
  return `<section class="section" id="specialties"><div class="wrap"><div class="center">${cx(d)}<p class="eyebrow">${esc(sp.eyebrow)}</p><h2>${esc(sp.h2)}</h2>${sp.intro ? `<p>${esc(sp.intro)}</p>` : ""}</div>
      <div class="cards" style="--ccols:${ccols(arr(sp.cards).length)}">${cards}</div></div></section>`;
}
...
function blockCards(b, d) {
  ...
  return `<section class="section"><div class="wrap"><div class="center">${cx(d)}<p class="eyebrow">${esc(b.eyebrow)}</p><h2>${esc(b.h2)}</h2>${b.intro ? `<p>${esc(b.intro)}</p>` : ""}</div><div class="cards" style="--ccols:${ccols(cs.length)}">${html}</div></div></section>`;
}
...
function renderFromBlueprint(kit, bp, title, pool) {
  const d = designOf(kit);
  const next = poolCursor(pool);
  // Fill empty image slots with the client's own scraped photos — no gradient
  // placeholders. Hero first (biggest, most important), then split/cards/gallery.
  const heroImage = bp.heroImage || next();
  for (const b of arr(bp.blocks)) {
    if (b.type === "split" && !b.image) b.image = next();
    else if (b.type === "cards") for (const c of arr(b.cards)) if (!c.image) c.image = next();
    else if (b.type === "gallery") { b.images = arr(b.images).filter(Boolean); while (b.images.length < 4) { const u = next(); if (!u) break; b.images.push(u); } }
  }
