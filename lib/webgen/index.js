...
const { renderPages, renderHome, renderServices, renderAbout, renderContact, renderFromBlueprint, DESIGN_IDS } = require("./render.js");
...
const { buildBlueprint } = require("./blueprint.js");
module.exports = {
  composeBrandKit, fallbackKit, themeTokens, renderPages, renderHome, renderServices, renderAbout, renderContact, renderFromBlueprint, DESIGN_IDS,
  scrape, scrapeLite, extractBrandKit, classifyImages, sanitizeImages, classifyPool, enrichKitImages, buildBlueprint,
};
